...
def main_dashboard():
    ...
    logo_image = PhotoImage(file=r"C:\\Users\\death\\OneDrive\\Pictures\\Camera Roll\\R.png")  # doesnt exist yet in my project directory
...
welcome_image = PhotoImage(file=r"welcome.png")  # remember to put welcome.png in my project directory
welcome_image = welcome_image.subsample(3, 3)
